...
<!--           <li><a href="<?php echo site_url('Accueil/equipe') ?>">L'Equipe</a></li>
 -->          <li><a href="<?php echo site_url('Accueil/Contact') ?>">Contactez nous</a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          { ?>
            <button onclick="location.href='<?php echo site_url('Espace_perso') ?>'" class="btn btn-default navbar-btn">MON PROFIL</button>
          ...
          { ?>
            <button onclick="location.href='<?php echo site_url('Utilisateur/inscription') ?>'" class="btn btn-default navbar-btn">S'INSRIRE</button>
