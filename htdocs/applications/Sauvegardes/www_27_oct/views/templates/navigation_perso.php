  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav">
          <li><a href="<?php echo site_url('Espace_perso/Mes_annonces/propose_trajet') ?>">Mes annonces</a></li>
          <li><a href="<?php echo site_url('Espace_perso/Mes_reservations/recherche_trajet') ?>">Mes réservations</a></li>
          <li><a href="<?php echo site_url('Espace_perso/Mes_formations') ?>">Mes formations</a></li> 
          <li><a href="<?php echo site_url('Espace_perso/Messagerie') ?>">Messagerie</a></li>          
          <li><a href="<?php echo site_url('Espace_perso/Avis') ?>">Avis</a></li>
          <li><a href="<?php echo site_url('Espace_perso/Profil') ?>">Profil</a></li> 
