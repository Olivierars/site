...
// MESSAGE ----------------------------------------------------
	...
	public function get_id_interloc_messages($id_trajet,$id_profil)
	{
		$table = 'message';
		$where_exped = "id_trajet = $id_trajet AND id_exped = $id_profil";
		$where_dest = "id_trajet = $id_trajet AND id_dest = $id_profil";
	...
	public function get_id_messages($id_trajet,$id_interloc,$id_profil)
	{
		$table = 'message';
	...
	public function get_id_trajet_messages($id)
	{
		$table = 'message';
		return $this->db->select('`id_trajet`',false)
			-> From($table)
