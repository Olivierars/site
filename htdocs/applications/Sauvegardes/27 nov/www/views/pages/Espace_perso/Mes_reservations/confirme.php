...
<div class="container">
  	<ul class="nav nav-pills">
		...
		<li role="presentation" class="active"><a href="<?php echo site_url('Espace_perso/Mes_reservations/confirme') ?>">Confirmées</a></li>
		<li role="presentation"><a href="<?php echo site_url('Espace_perso/Mes_reservations/archives') ?>">Archivées</a></li>
  	</ul>

	<h3>Mes accompagnements confirmés </h3>
    ...
    $j = 0;
      ...
      for($i =0;$i<= $Nof_trajet_confirme-1 ; $i++ )
		...
		if($j==0 )
		{
			echo "Vous n'avez pas d'accompagnement confirmé" ;
		}
 		?>
</div>