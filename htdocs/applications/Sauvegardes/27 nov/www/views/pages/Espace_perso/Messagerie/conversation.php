		...
		{ ?>
			<div class="row" id="texte_centre">
				<div class="col-md-7 col-md-offset-1">
					...
					echo " -- ".$data_trajet[$i][0]->ville_depart." >> ".$data_trajet[$i][0]->ville_arrivee."</strong></h4> ";
			...
			<div class="row" >
				...
				<div class="form-group">
					<input type="hidden" name="id_trajet" 		value="<?php echo $data_trajet[$i][0]->id;?>" />
			...
			{	
				...
				{?>
					...
					<div class="row">
						...
						<div class="col-md-1">
							<?php 
							$filename = "../assets/images/photos_profil/photo_profil_".$data_message[$i][$j][0]->id_exped.".jpg" ;
							if (file_exists($filename))
							{ ?>
								<img id='message_profil_pict' src=<?php echo "/assets/images/photos_profil/photo_profil_".$data_message[$i][$j][0]->id_exped.".jpg";?> class="profile-image img-circle" alt="photo de profil"> 
