    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav">
          ...
          { ?>
          <button id="propose_button" onclick="location.href='<?php echo site_url('Espace_perso/Mes_annonces/propose_trajet') ?>'" class="btn btn-default navbar-btn"> Demander un accompagnement</button>
          <?php 
          }  
          elseif(strcmp($data_profil[0]->role,"accompagnateur")==0)
          {?>
            <button id="recherche_button" onclick="location.href='<?php echo site_url('Espace_perso/Mes_reservations/recherche_trajet') ?>'" class="btn btn-default navbar-btn">Consulter les demandes d'accompagnement</button>
          <?php
          }?>
         </ul>
