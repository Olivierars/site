...
<nav id = "header" class="navbar navbar-inverse navbar-fixed-top">    <div class="container">
    <div class="container-fluid">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo site_url('Accueil') ?>"> <FONT COLOR=#FFFFFF>HANDIvalise ! </FONT></a>
      </div>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav">
          ...
          { ?>
          <button onclick="location.href='<?php echo site_url('Espace_perso/Mes_annonces/propose_trajet') ?>'" class="btn btn-success navbar-btn"> Solliciter un accompagnement</button>
          <?php 
          }  
          elseif(strcmp($data_profil[0]->role,"accompagnateur")==0)
          {?>
            <button onclick="location.href='<?php echo site_url('Espace_perso/Mes_reservations/recherche_trajet') ?>'" class="btn btn-success navbar-btn">Rechercher un trajet</button>
          <?php
          }?>
         </ul>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li class="<?php if( $menu == "mes_annonces"){echo "active";}?>"><a href="<?php echo site_url('Espace_perso/Mes_annonces/propose_trajet') ?>">
            <span class="glyphicon glyphicon-road" aria-hidden="true"></span> Mes demandes</a></li>
          <?php 
          }  
          elseif(strcmp($data_profil[0]->role,"accompagnateur")==0)
          {?>
          <li class="<?php if( $menu == "mes_reservations"){echo "active";}?>"><a href="<?php echo site_url('Espace_perso/Mes_reservations/recherche_trajet') ?>">
            <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> Mes accompagnements</a></li>
          <?php
          }?>
          ...
          <li class="<?php if( $menu == "messagerie"){echo "active";}?>"><a href="<?php echo site_url('Espace_perso/Messagerie') ?>">
            <span class="glyphicon glyphicon-comment" aria-hidden="true"></span> Messagerie <span class="badge">42</span></a></li>          
