...
<div class="container">
					...
					<div class="panel panel-primary">
						<ul class="list-group">
							<div class="panel-body" id="listing_message">
								<a display:block href="<?php echo site_url('Espace_perso/Messagerie/conversation/'.$data_message[$i][$j][0][0]->id) ?>">
								<!-- PHOTO  -->
								<div class="col-md-1">
									<?php
								...
								<div class="col-md-4"> <?php 
									...
									{
										echo ucfirst($data_profil[0]->prenom).", le ".$date_message." à ".$heure_message." : <br>";
									}
									else
									{
										echo ucfirst($data_interloc[$i][0]->prenom).", le ".$date_message." à ".$heure_message." : <br>";
									}	
	...
	{?>
		<div class="container">
			<?php echo "Vous n'avez pas de message concernant des trajets en cours "  ;  ?>
		</div>
		<?php
	}?>				
</div>
